...
export const mockExpenses: Omit<MockExpenseTransaction, 'userId'>[] = [
    ...
    { date: '2024-07-23', company: 'SaaS Tools Co.', description: 'Software subscription', totalAmount: 75.99, category: 'Software', explanation: 'Monthly subscription for design software', documentNumber: 'SAAS-12345', type: 'business' },
    { date: '2024-07-20', company: 'Office Supply Hub', description: 'Printer paper and ink', totalAmount: 45.30, category: 'Office Supplies', explanation: 'Restock office supplies', documentNumber: 'OSH-54321', type: 'business' },
    { date: '2024-07-18', company: 'Jane Designs', description: 'Contract graphic design work', totalAmount: 800, category: 'Contractors', explanation: 'Logo design for new project', documentNumber: 'JD-2024-07', type: 'business' },
];

...
export const mockIncome: Omit<MockIncomeTransaction, 'userId'>[] = [
    { date: '2024-07-25', company: 'Client Alpha', description: 'Payment for web development services', amount: 5000, incomeCategory: 'Service Revenue', depositedTo: 'Bank Account #1', explanation: 'Invoice #2024-015', documentNumber: '2024-015', type: 'business' },
    { date: '2024-07-24', company: 'E-commerce Store', description: 'Stripe Payout', amount: 850.75, incomeCategory: 'Sales Revenue', depositedTo: 'Bank Account #1', explanation: 'Daily sales payout', documentNumber: 'STR-240724', type: 'business' },
    { date: '2024-07-22', company: 'Client Beta', description: 'Consulting services retainer', amount: 2500, incomeCategory: 'Consulting', depositedTo: 'Bank Account #1', explanation: 'July Retainer', documentNumber: 'RET-007', type: 'business' },
    { date: '2024-07-20', company: 'Affiliate Payout', description: 'Affiliate commission', amount: 120.50, incomeCategory: 'Other Income', depositedTo: 'Bank Account #1', explanation: 'Q2 Affiliate Payout', documentNumber: 'AFF-Q2-2024', type: 'business' },
];

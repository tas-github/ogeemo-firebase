...
export function ProjectsView() {
  const features = [
    { icon: Briefcase, title: "All Projects List", description: "A comprehensive list of every project. Use this view to edit project details.", href: "/projects/all", cta: "View All Projects" },

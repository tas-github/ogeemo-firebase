...
export function CalendarView() {
    ...
    const timeIncrements = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60];
                ...
                <div className="flex-1 min-h-0 flex flex-col">
                    <div className="flex items-center justify-between flex-wrap gap-4 pb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Select value={String(dayCount)} onValueChange={(value) => setDayCount(Number(value))}><SelectTrigger className="w-[120px]"><SelectValue /></SelectTrigger><SelectContent>{Array.from({ length: 30 }, (_, i) => i + 1).map(day => (<SelectItem key={day} value={String(day)}>{day}-Day</SelectItem>))}</SelectContent></Select>

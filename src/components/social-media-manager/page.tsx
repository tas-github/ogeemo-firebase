                ...
                <div className="flex items-start gap-4">
                 ...
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Directly access approved brand assets, product photos, and marketing materials from your Document Manager to attach to your posts, ensuring brand consistency.</p>
                    </div>
                </div>
                 <div className="flex items-start gap-4">
                    <div className="p-3 bg-primary/10 rounded-lg mt-1">

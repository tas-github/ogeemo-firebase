...
p           <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.447-2.274 4.481-4.244 5.892l6.19 5.238C42.012 35.245 44 30.028 44 24c0-1.341-.138-2.65-.389-3.917z"/>
        </svg>
    )
}
...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // DEBUG: Log the configuration object being used by Firebase Auth
    console.log("Using Firebase config:", firebaseServices.auth.config);
